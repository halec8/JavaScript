...
echo "<h1>$formEmailAddress </h1>";
echo "<h1>$formTopic </h1>";
...
<head>
    ...
    <style>
        <?php include "contact_form_response_style.css" ?>
    </style>
...
$toEmail = "hale.l.c91@codyhale.name";		//will send the email to the email address entered on the form
...
$fromEmail = "hale.l.c91@codyhale.name";		//Change the email address within the quotes to be YOUR host server email address.
...
{
    echo("<p>Message successfully sent! Click here
<a href=http://codyhale.name/index.html/>Home</a> to go back to the home page.</p>");
}
else
{
    echo("<p>Message delivery failed...Click here:
<a href=http://codyhale.name/index.html/>Home</a> to go back to the home page./p>");
}
